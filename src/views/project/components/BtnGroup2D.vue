...
import { receiveJob, receiveCheck, completeJob, completeCheck, closeGroup, openGroup, startJob, startCheck } from "@/api/project/2d"
import { Job2DPerBtn, Check2DPerBtn, waitCheck2DBtn, waitJob2DBtn } from '../config/btn2d.js'
export default {
  name: 'BtnGroup2D',
  props: {
    tabName: {
  ...
  computed: {
    btns() {
      switch (this.tabName) {
        case 'task':
          return this.Job2DPerBtn
        case 'check':
          return this.Check2DPerBtn
        case 'jobWaitTask':
          return this.waitJob2DBtn
        case 'CheckWaitTask':
          return this.waitCheck2DBtn
      }
    }
  },
  data() {
    return {
      Job2DPerBtn, Check2DPerBtn, waitCheck2DBtn, waitJob2DBtn
    }
  },
  methods: {
    checkPermi,
