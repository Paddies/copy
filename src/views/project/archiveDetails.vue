  ...
  <div class="app-container">
    ...
    <div style="width: 100%;height: 80px;">
      ...
      <div style="width:100px;float: right;">
        <el-button type="primary" icon="el-icon-edit" @click="openProject()"
             v-hasPermi="['project:list:open']">还原</el-button>
      </div>
    </div>
    ...
    <el-tabs v-model="activeName" @tab-click="tabChange">
      ...
      <el-tab-pane v-if="checkPermi(taskPermision)" label="标注任务" name="task" lazy>
        <el-card shadow="hover" v-if="tabSHow">
          <TabPane :loading="tableLoading" ref="taskTable" :projectType="form.projectType" :data="tasksData" :archive="false"
      ...
      <el-tab-pane v-if="checkPermi(checkPermision)" label="质检任务" name="check" lazy>
        <el-card shadow="hover" v-if="tabSHow">
          <TabPane :loading="tableLoading" ref="taskCheckTable" :projectType="form.projectType" :data="checkTaskData" :archive="false"
      ...
      <el-tab-pane v-if="checkPermi(waitTaskPermision) &&
        ...
        <el-card shadow="hover" v-if="tabSHow">
          <TabPane :loading="tableLoading" ref="waittaskTable" :projectType="form.projectType" :activeName="activeName" :archive="false"
      ...
      <el-tab-pane v-if="checkPermi(waitCheckPermision) &&
        ...
        <el-card shadow="hover" v-if="tabSHow">
          <TabPane :loading="tableLoading" ref="waitChecktaskTable" :projectType="form.projectType" :archive="false"
      ...
      <el-tab-pane label="标注员名单" name="marker" lazy>
        <el-card shadow="hover" v-if="tabSHow">
          <TabPane :loading="tableLoading" :pagination="markerPage" :data="markersData" :isEdit="true" :archive="false"
      ...
      <el-tab-pane label="质检员名单" name="checker" lazy>
        <el-card shadow="hover" v-if="tabSHow">
          <TabPane :loading="tableLoading" :pagination="checkerPage" :data="checkersData" :isEdit="true" :archive="false"
      ...
      <el-tab-pane label="文件管理" name="file" lazy>
        <el-card shadow="hover" v-if="tabSHow">
          <TabPane :loading="tableLoading" :data="filesData" :pagination="filePage" :isEdit="true" :archive="false"
