  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" v-show="showSearch" :inline="true">
      ...
      <el-form-item label="文件名称" prop="fileName">
        <el-input v-model="queryParams.fileName" placeholder="请输入文件名称" clearable size="small" style="width: 240px"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
...
<script>
import { page, add, update, del } from "@/api/system/fileUp3D";
...
export default {
  ...
  data() {
    return {
      ...
      tagFormRules: {
        tags: [{ required: true, message: "请输入标签名称" }],
      },
      // 遮罩层
      loading: true,
      // 选中数组
      ...
      deptNodeAll: false,
      //文件上传地址
      fileUrl: process.env.VUE_APP_BASE_API + "/tools/upFile3D",
      // 查询参数
      queryParams: {
        pageNum: 1,
        pageSize: 50,
