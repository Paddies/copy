  ...
  <div class="layout-container">
    ...
    <div class="content">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>创建个人工会</el-breadcrumb-item>
      </el-breadcrumb>
      <div class="message">
        ...
        <div class="message-bottom">
          ...
          <div class="message-center">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
              ...
              <el-form-item label="身份证件" prop="name">
                <div>
                  <!-- <span>上传身份证人像面</span><span>上传身份证国徽面</span> -->
                  <img src="../../assets/images/Frame239.png" alt="">
                </div>
              </el-form-item>
              <el-form-item label="通讯地址" prop="region">
                ...
                <el-input v-model="ruleForm.name" placeholder="具体街道地址" style="margin-top: 10px"></el-input>
              </el-form-item>
