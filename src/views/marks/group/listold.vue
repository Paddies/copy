<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" v-show="showSearch" :inline="true">
      ...
      <!--        <el-input v-model="queryParams.chartModel" placeholder="请输入" />-->
      <!--      </el-form-item>-->
      <!--      <el-form-item label="功能" prop="model">-->
      <!--        <el-input v-model="queryParams.chartFunction" placeholder="请输入" />-->
      <!--      </el-form-item>-->
    ...
    <el-table :data="roleList" v-loading="loading">
      ...
      <el-table-column label="附件ID" prop="sourceId">
        <template slot-scope="scope">
          <div @click="downFile(scope.row)">{{ scope.row.sourceId }}</div>
        </template>
      </el-table-column>
      <el-table-column label="文件名称" prop="fileName" :formatter="jobTypeFormat" />
      <el-table-column label="json定制数据" prop="note" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)">修改</el-button>
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)">删除</el-button>
          <el-button size="mini" type="text" icon="el-icon-delete" @click="toJob(scope.row)">任务</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { page, add, update, del } from "@/api/project/group";
...
export default {
  ...
  methods: {
    ...
    toJob(row) {
      this.$router.push({ path: '/marks/list?groupId=' + row.id })
    },
    // 所有菜单节点数据
